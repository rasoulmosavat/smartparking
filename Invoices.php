...
<section class="row mx-md-0">
            ...
            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 leftmenu">
                    ...
                    <div class="col-md-12">
                                   ...
                                   <br>
                              <a  href="https://saljningzone.se/"><img style="width:22px;height:22px;" src="icones/iconfinder_file_add.png"> Dashboard</a>
                                <hr>
                                     <a  href="https://saljningzone.se/searchparking.php"><img style="width:22px;height:22px;" src="icones/iconfinder_file_add.png"> Search Parking</a>
                                
                              
                                <hr>
                                  
                                     <a  href="https://saljningzone.se/edituser.php"><img style="width:22px;height:22px;" src="icones/iconfinder_file_add.png"> Edit User</a>
                                
                                  
                                  <hr>
                                 
                                       <a  href="https://saljningzone.se/invoices.php"><img style="width:22px;height:22px;" src="icones/iconfinder_file_add.png"> Invoices</a>
                                ...
                                <hr>
                                     ...
                                     <a  href=""><img style="width:22px;height:22px;" src="icones/iconfinder_file_add.png"> Logout</a>
                                <hr>
